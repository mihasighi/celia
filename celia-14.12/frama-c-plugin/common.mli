...
val mkpredicate :
  string list -> Cil_types.location -> Cil_types.predicate -> Cil_types.predicate Cil_types.named
...
val mkalloc_array_statement :
  Cil_types.varinfo ->
  Cil_types.typ -> Integer.t -> Cil_types.location -> Cil_types.stmt
...
val is_bswap_function : Cil_types.varinfo -> bool
