...
/** Ushapes are built from a heap graph and an array (of size
    ...
    struct _ushape_t {
        hg_abstract0_t *h; /* heap graph (or NULL) */
...
#define NODE_LENDIM(datadim,size,node) (datadim + size + node)
    ...
    void ushape_fdump_internal(FILE * stream, ushape_internal_t * pr,
            ushape_t * a);
    ...
    void
    ushape_apply_addsglt(ushape_internal_t * pr, ushape_t * a, ushape_t * b,
            ap_dim_t dim, int fld);
    ...
    void
    ushape_apply_expand(ushape_internal_t * pr, ushape_t * a, ushape_t * b,
            ap_dim_t dim, size_t n);

    void
    ushape_apply_fold(ushape_internal_t * pr, ushape_t * a, ushape_t * b,
