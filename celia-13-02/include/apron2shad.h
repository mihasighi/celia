...
#ifndef __APRON2SHAD_H_
#define __APRON2SHAD_H_
...
#define PTR2REAL_DIM(d)   d
#define REAL2PTR_DIM(d)   d
...
#define NULL_DIM      AP_DIM_MAX
    ...
    // TODO: remove this and the code using it
#define DATA_DIM(intdim,ptrdim) intdim
#define LEN_DIM(intdim,ptrdim)  0

    /* Encoding of operations on pointers */
    // with AP_TEXPR_CAST
#define IS_OFFSET(t,d)      \
     ((t==AP_RTYPE_INT || t==AP_RTYPE_REAL) && (d==AP_RDIR_ZERO || d==AP_RDIR_UP))
...
#define IS_ALLOC_STMT(t,d)  (t==AP_RTYPE_SINGLE && d==AP_RDIR_NEAREST)
    ...
    /* Global Tables */
    /* ================================================================== */
    extern pcons0_t *pcons_table;       /* hash table for pointer constraints */
    extern passign0_t *passign_table;   /* hash table for pointer assignment */
    ...
    passign0_array_t *shape_passign_of_linexpr_array(ap_dim_t * lhs, ap_linexpr0_t ** rhs,
            size_t size, size_t intdim, size_t ptrdim);
    passign0_t *shape_passign_of_texpr(ap_dim_t lhs,
            ap_texpr0_t * rhs, size_t intdim, size_t ptrdim);
    passign0_array_t *shape_passign_of_texpr_array(ap_dim_t * lhs, ap_texpr0_t ** rhs,
            size_t size, size_t intdim, size_t ptrdim);
    /*
