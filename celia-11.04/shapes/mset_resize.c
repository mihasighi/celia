...
#ifndef NDEBUG
    fprintf(stdout, "\n===== mset_permute_dimensions: perm,newperm,consperm\n");
    ap_dimperm_fprint(stdout, perm);
...
#ifndef NDEBUG
    fprintf(stdout, "\n====mset_unfold - before substitute l[n1]\n");
    mset_fdump(stdout, pr->man, r);
    fflush(stdout);
#endif
    // l[n1] == l[n2] + 1;
...
#ifndef NDEBUG
    fprintf(stdout,
            "\n====mset_unfold - after substitute l[n1], before assign l[n1]\n");
    mset_fdump(stdout, pr->man, r);
    fflush(stdout);
#endif
    // l[n1] := 1;
...
mset_split(mset_internal_t* pr, bool destructive, mset_t* a, ap_dim_t dim) {
    ...
    r->lcons =
            ...
            NULL);
#ifndef NDEBUG
    fprintf(stdout, "\n====mset_unfold - after substitute l[n1]\n");
    mset_fdump(stdout, pr->man, r);
    fflush(stdout);
#endif
    // meet l[n1]-1 >= 0 && l[n2]-1 >= 0
