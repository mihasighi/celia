  ...
  if (a == (struct char_P *)0) { /*sid:3*/ res = fold_clone(a); }
    ...
    if (start == (struct char_P *)0) { /*sid:7*/ res = fold_clone(a); }
      ...
      { /*undefined sequence*/ 
        ...
        /*effects:  <- */
        /*sid:27*/
        right->struct_intlist__xM = tmp_1;
        /*effects: right->struct_intlist__xM <- tmp_1, right*/
        /*sid:28*/
        tmp_0 = tmp_1;
        /*effects:  <- */
        /*sid:29*/
        left->struct_intlist__xM = tmp_0;
        /*effects: left->struct_intlist__xM <- tmp_0, left*/
        /*sid:30*/
        tmp = tmp_0;
        /*effects: tmp <- */
      }
                ...
                struct struct_intlist__xP *u ) 
{
  ...
  { /*undefined sequence*/ 
    /*sid:81*/
    tmp_0_1 = (struct intlist_ *)((struct char_P *)0);
    /*effects: tmp_0_1 <- */
    /*sid:82*/
    y_0 = tmp_0_1;
    /*effects: y_0 <- */
