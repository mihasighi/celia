...
/*Loc=../../../c/intlist-map-addV.c(9,9)*//*@ requires //id:67
                                                       acyclic{Here}(head);
                                              behavior default:
                                          ...
                                          void map_addV(intlist head , int v ) 
{
  intlist h ;
  intlist tmp ;
  /*Loc=../../../c/intlist-map-addV.c:(11,11)*//*sid:1*/
  { /*undefined sequence*/ 
    /*Loc=../../../c/intlist-map-addV.c:(11,11)*//*sid:2*/
    tmp = (struct intlist_ *)((struct char_P *)0);
    /*effects: tmp <- */
    /*Loc=../../../c/intlist-map-addV.c:(11,11)*//*sid:3*/
    h = tmp;
    /*effects: h <- */
  }
  /*Loc=../../../c/intlist-map-addV.c:(12,12)*//*sid:4*/
  h = head;
  /*Loc=../../../c/intlist-map-addV.c:(13,13)*//*sid:5*/
  while (h != (struct char_P *)0) {
    /*Loc=../../../c/intlist-map-addV.c:(14,14)*//*sid:9*/
    h->data += v;
    /*Loc=../../../c/intlist-map-addV.c:(15,15)*//*sid:10*/
    tmp = h->next;
    /*Loc=../../../c/intlist-map-addV.c:(16,16)*//*sid:11*/
    h = (struct intlist_ *)((struct char_P *)0);
    /*Loc=../../../c/intlist-map-addV.c:(17,17)*//*sid:12*/
    h = tmp;
    /*Loc=../../../c/intlist-map-addV.c:(18,18)*//*sid:13*/
    tmp = (struct intlist_ *)((struct char_P *)0);
  }
  /*Loc=../../../c/intlist-map-addV.c:(20,20)*//*sid:15*/
  return;
}
